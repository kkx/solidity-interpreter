...
contract Interpreter {
     ...
     */
    function interpret(uint16[] calldata instructions) onlyOwnerOrCreator public {
     ...
     */
    function interpretWithProtoBuff(bytes calldata program) onlyOwnerOrCreator public {
        (
            bool success,
            uint64 pos,
            uint64 field,
